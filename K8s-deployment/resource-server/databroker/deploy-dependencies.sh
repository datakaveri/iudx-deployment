...
kubectl create secret generic rabbitmq-erlang-cookie --from-file=../../secrets/passwords/rabbitmq-erlang-cookie -n rabbitmq-test
kubectl create secret generic rabbitmq-definition-file --from-file=../../secrets/passwords/rabbitmq-definitions.json -n rabbitmq-test
