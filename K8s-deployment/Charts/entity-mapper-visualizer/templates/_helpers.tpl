...
{{- $messages := list -}}
{{- $messages := append $messages (include "catalogue.entityMapperVisualizer.validateValues.foo" .) -}}
{{- $messages := append $messages (include "catalogue.entityMapperVisualizer.validateValues.bar" .) -}}
