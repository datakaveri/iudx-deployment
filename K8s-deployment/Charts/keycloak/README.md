...
## Docker image
Custom docker image ``ghcr.io/datakaveri/keycloak:18.0.2`` based on [bitnami keycloak image](https://hub.docker.com/r/bitnami/keycloak/) is used. The details are present at ../../Docker-Swarm-deployment/single-node/keycloak.
