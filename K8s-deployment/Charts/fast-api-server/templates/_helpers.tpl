...
{{- $messages := list -}}
{{- $messages := append $messages (include "catalogue.fastApiServer.validateValues.foo" .) -}}
{{- $messages := append $messages (include "catalogue.fastApiServer.validateValues.bar" .) -}}
