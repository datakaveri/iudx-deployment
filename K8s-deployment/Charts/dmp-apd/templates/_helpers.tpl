...
*/}}
{{- define "dmp-apd.volumePermissions.image" -}}
...
*/}}
{{- define "dmp-apd.imagePullSecrets" -}}
...
*/}}
{{- define "dmp-apd.serviceAccountName" -}}
...
*/}}
{{- define "dmp-apd.ingress.certManagerRequest" -}}
...
*/}}
{{- define "dmp-apd.validateValues" -}}
{{- $messages := list -}}
{{- $messages := append $messages (include "dmp-apd.apiServer.validateValues.foo" .) -}}
{{- $messages := append $messages (include "dmp-apd.apiServer.validateValues.bar" .) -}}
