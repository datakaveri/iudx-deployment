...
{{- $messages := list -}}
{{- $messages := append $messages (include "catalogue.auditingServer.validateValues.foo" .) -}}
{{- $messages := append $messages (include "catalogue.auditingServer.validateValues.bar" .) -}}
