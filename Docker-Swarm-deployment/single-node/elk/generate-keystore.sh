...
docker run \
    ...
    docker.io/bitnami/kibana:8.7.0-debian-11-r0 /opt/bitnami/kibana/bin/run.sh
...
docker run \
    ...
    docker.io/bitnami/logstash:8.7.0-debian-11-r0 /opt/bitnami/logstash/bin/run.sh
