  ...
  stages {
    stage('Kubescape Scan for RS') {
      ...
      steps {
        ...
        publishHTML([allowMissing: false, alwaysLinkToLastBuild: true, keepAll: true, reportDir: '/var/lib/jenkins/workspace/testing-kubescape/', reportFiles: 'rs-report.pdf', reportName: 'Kubescape Scan Report for RS'])
      }
    }
    ...
    stage('Kubescape Scan for Auth') {
      ...
      steps {
        ...
        publishHTML([allowMissing: false, alwaysLinkToLastBuild: true, keepAll: true, reportDir: '/var/lib/jenkins/workspace/testing-kubescape/', reportFiles: 'auth-report.pdf', reportName: 'Kubescape Scan Report for AUTH'])
      }
    }
    ...
    stage('Kubescape Scan for CAT') {
      ...
      steps {
        ...
        publishHTML([allowMissing: false, alwaysLinkToLastBuild: true, keepAll: true, reportDir: '/var/lib/jenkins/workspace/testing-kubescape/', reportFiles: 'cat-report.pdf', reportName: 'Kubescape Scan Report for CAT'])
      }
    }
    ...
    stage('Kubescape Scan for LIP') {
      ...
      steps {
        ...
        publishHTML([allowMissing: false, alwaysLinkToLastBuild: true, keepAll: true, reportDir: '/var/lib/jenkins/workspace/testing-kubescape/', reportFiles: 'lip-report.pdf', reportName: 'Kubescape Scan Report for LIP'])
      }
    }
    ...
    stage('Kubescape Scan for FS') {
      ...
      steps {
        ...
        publishHTML([allowMissing: false, alwaysLinkToLastBuild: true, keepAll: true, reportDir: '/var/lib/jenkins/workspace/testing-kubescape/', reportFiles: 'fs-report.pdf', reportName: 'Kubescape Scan Report for FS'])
      }
    }
    ...
    stage('Kubescape Scan for GIS') {
      ...
      steps {
        ...
        publishHTML([allowMissing: false, alwaysLinkToLastBuild: true, keepAll: true, reportDir: '/var/lib/jenkins/workspace/testing-kubescape/', reportFiles: 'gis-report.pdf', reportName: 'Kubescape Scan Report for GIS'])
      }
    }
    ...
    stage('Kubescape Scan for DI') {
      ...
      steps {
        ...
        publishHTML([allowMissing: false, alwaysLinkToLastBuild: true, keepAll: true, reportDir: '/var/lib/jenkins/workspace/testing-kubescape/', reportFiles: 'di-report.pdf', reportName: 'Kubescape Scan Report for DI'])
      }
    }    
  }
}
