...
<head>
    ...
    <style>
        body, html, input, button, select, textarea, label, .form-control, .btn {
...
<!-- Top left logo on background -->
<div style="position: fixed; top: 20px; left: 20px; z-index: 1000; display: flex; align-items: center;">
    <img src="${url.resourcesPath}/img/adarv-logo.svg" alt="Logo" style="height: 56px; width: 164px;" />
    <span style="
        margin-left: 18px;
        color: var(--main-col, #5D5A88);
        ...
        Advanced Data Analytics <br> &amp; Research Ventures
    </span>
</div>
