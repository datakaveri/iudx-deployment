    ...
    <#elseif section = "form">
        <ol id="kc-totp-settings">
            <li style="font-weight:600">
                <p style="color:black !important">${msg("loginTotpStep1")}</p>
            ...
            <#else>
                <li  style="font-weight:600">
                    <p style="color:black !important">${msg("loginTotpStep2")}</p>
                    <img id="kc-totp-secret-qr-code" src="data:image/png;base64, ${totp.totpSecretQrCode}" alt="Figure: Barcode"><br/>
                    <p><a href="${totp.manualUrl}" id="mode-manual">${msg("loginTotpUnableToScan")}</a></p>
                </li>
            </#if>
            <li style="font-weight:600">
                <p style="color:black !important">${msg("loginTotpStep3")}</p>
                <p style="color:black !important">${msg("loginTotpStep3DeviceName")}</p>
            </li>
        </ol>
